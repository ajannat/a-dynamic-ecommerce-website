	...
	<body style="min-width: 980px;">
		...
		<div class="container">
			<div class="row">
						...
						<form id="myform" method="post">
							<div class="form-group categories">
								...
								<ul>
									...
									<li><a href="category/<?php echo $data; ?>"><?php echo $cat_name_up; ?></a></li>
									<?php } ?>
								</ul>
				...
				<div class="col-md-9">
					<div class=" row home-items pl-5" style="padding: 50px 10px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">

						<?php 

							$query = "SELECT * FROM products WHERE available >='1' LIMIT 15" or die(mysqli_error());
							$getposts = mysqli_query($db_connect, $query);
									...
									echo '
										...
										<ul style="">
											<li style="padding: 0px 15px 15px 15px;">
